...
// Regression: Auf Seite 3 des EEG-Registration-Wizards wird ein Validierungsfehler
// angezeigt, obwohl die Netzbetreiber-ID ausgefüllt ist. Ursache: Auswahl der
// Netzbetreiber-ID befüllt grid.name per setValue OHNE Neuvalidierung -> der zuvor
// gesetzte required-Fehler "Netzbetreiber-Name fehlt" bleibt sichtbar stehen.
